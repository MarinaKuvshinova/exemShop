    ...
    <div class="menu_nav">
        <ul>
            @foreach($categories as $category)
                                <li><a href="{{url("home/catalog/$category->categoryName")}}">{{$category->categoryName}}</a></li>
                                @endforeach
        ...
        <div class="header_content d-flex flex-row align-items-center justify-content-start">
            ...
            <nav class="main_nav">
                <ul class="d-flex flex-row align-items-start justify-content-start">
                    @foreach($categories as $category)
                    <li class="{{ Request::path() == 'home/catalog/'.$category->categoryName ? 'active' : '' }}"><a href="{{url("home/catalog/$category->categoryName")}}">{{$category->categoryName}}</a></li>
                    @endforeach
                    {{--<li class="active"><a href="#">Women</a></li>--}}
                    {{--<li><a href="{{url('home/catalog')}}">Men</a></li>--}}
                    {{--<li><a href="{{url('home/catalog')}}">Kids</a></li>--}}
                    {{--<li><a href="{{url('home/catalog')}}">Home Deco</a></li>--}}
                    <li class="{{ Request::path() == 'home/contact' ? 'active' : '' }}"><a href="{{url('home/contact')}}">Contact</a></li>
                </ul>
            </nav>
            <div class="header_right d-flex flex-row align-items-center justify-content-start ml-auto">
                ...
                <!-- Cart -->
                <div class="cart"><a href="cart.html"><div><img class="svg" src="{{asset('images/cart.svg')}}" alt="https://www.flaticon.com/authors/freepik"></div></a></div>
                <!-- Phone -->
